...
class AgentPlayMode:
    ...
    def __init__(self, model_path="ppo_pacman.zip", time_limit_minutes=10, countdown_seconds=5, freeze_mode_first=True, window_size=None):
        ...
        self.advice_frequency = 200  # Ask for advice every 50 steps
    ...
    def create_pacman_env(self):
        ...
        env = AtariWrapper(
            env,
            frame_skip=1,        # No skipping to avoid invisible collisions
    ...
    def run(self):
        ...
        while running:
            ...
            # Take multiple logic steps per displayed frame and build a fresh composite
            terminated = False
            truncated = False
            composite = None
